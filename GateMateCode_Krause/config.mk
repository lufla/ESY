...
vlog_sim.vvp:
	$(IVL) $(IVLFLAGS) -o sim/iverilog/$@ $(VLOG_SRC) sim/iverilog/$(TOP)_tb.v $(CELLS_SYNTH)

synth_sim.vvp:
	$(IVL) $(IVLFLAGS) -o sim/iverilog/$@ net/$(TOP)_synth.v sim/iverilog/$(TOP)_tb.v $(CELLS_SYNTH)
